...
class TestFile
  ...
  puts "\n=== Testing the modified map method ==="
  ...
  # Test 16: Complex example from original assignment
  b = ["cat", "bat", "mat", "sat", "rat", "hat"]
  result16_1 = b.map(2) { |x| x[0].upcase + x[1,x.length] }
  puts "Test 16.1: complex mapping with step 2 = #{result16_1} (Expected: [\"Cat\", \"Mat\", \"Rat\"])"
